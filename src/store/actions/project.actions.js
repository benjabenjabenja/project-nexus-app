...
// GET
export const SET_GET_PROJECTS = createAction('@GET_PROJECTS');
export const SET_GET_PROJECTS_SUCCESS = createAction('@GET_PROJECTS/SUCCESS');
export const SET_GET_PROJECTS_ERROR = createAction('@GET_PROJECTS/ERROR');
export const SET_GET_PROJECTS_CLEAR = createAction('@GET_PROJECTS/CLEAR');
